                ...
                <div className="flex justify-between items-start mb-3 gap-3">
                    <div className="flex-1">
                        ...
                        <DebouncedFormInput
                            ...
                            onChange={(val) => handleChange(val, i, "description")}
                        />
                    </div>
                    <button
                    ...
                    <div className="flex flex-col">
                        <label className="text-[10px] uppercase font-bold text-slate-600 mb-1 block">Qty</label>
                         <DebouncedFormInput
                            ...
                            placeholder={"0"}
                            value={item.quantity}
                            onChange={(val) => handleChange(val, i, "quantity")}
                        />
                    </div>
                    <div className="flex flex-col">
                        ...
                        <DebouncedFormInput
                            ...
                            onChange={(val) => handleChange(val, i, "unitPrice")}
                        />
                    </div>
                    <div className="flex flex-col">
