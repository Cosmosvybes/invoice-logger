      ...
      <Container className="bg-white border border-gray-200 rounded-lg shadow-sm mx-auto p-0 overflow-hidden max-w-2xl">
          ...
          <Row>
            <Column>
              <Img
                ...
                src="https://steadybill.pro/brand-assets/logo.png"
                alt="STEADYBILL"
              />
            </Column>
            <Column align="right">
        ...
        <Section className="px-8 py-8 text-center bg-white">
          ...
          {invoiceInformation.paymentLink && (
             <Button
               className="bg-primary text-white px-8 py-4 rounded-lg font-bold text-sm no-underline mt-4 shadow-md inline-block"
